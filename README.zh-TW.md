...
**ZYC.Automation** 是一個現代化的桌面自動化解決方案，結合了 **WPF** 的高表現力 UI 能力與 **.NET 10** 的最新技術特性。  
...
ZYC.Automation
├── src
│   ├── ZYC.Automation.Core               # 核心框架、在地化、例外處理
│   ├── ZYC.Automation.Modules.Aspire     # Aspire AppHost／協調整合
│   ├── ZYC.Automation                    # WPF 桌面宿主入口
│   └── ...
├── docs                                  # 文件
└── ...
```
