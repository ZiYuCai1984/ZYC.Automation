...
internal class HttpStream : Stream, IHttpStreamWriter, IHttpStreamReader, IPeekStream
{
        ...
        SessionEventArgs args, CancellationToken cancellationToken)
    {
        ...
        if ((IsNetworkStream && writer.IsNetworkStream &&
             isRequest && args.HttpClient.Request.OriginalHasBody && !args.HttpClient.Request.IsBodyRead &&
             server.ShouldCallBeforeRequestBodyWrite()) ||
            (isResponse && args.HttpClient.Response.OriginalHasBody && !args.HttpClient.Response.IsBodyRead &&
             server.ShouldCallBeforeResponseBodyWrite()))
        {
